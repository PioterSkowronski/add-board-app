            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <div class="form-group">
                            <form:input path="email" type="text" class="form-control form-control-user" id="exampleInputEmail"
                        ...
                        <div class="form-group">
                            <form:input path="phoneNumber" type="text" class="form-control form-control-user"
