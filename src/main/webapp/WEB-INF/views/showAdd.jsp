    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">${advert.title}</h1>
                <br>
                <p>--------------------------------------------</p>
                <h3>${advert.description}</h3>
                <h3>Cena: ${advert.price}PLN</h3>
                <h3>Kontakt: ${advert.user.firstName}  <br> tel. ${advert.user.phoneNumber}  <br> Email: ${advert.user.email}</h3>
                <p>Utworzono: ${advert.created}</p>
                <p>--------------------------------------------</p>
                <br><br>
